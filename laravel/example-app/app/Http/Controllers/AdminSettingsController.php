...
class AdminSettingsController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        if (($validated['security_action'] ?? null) === 'logout_all') {
            AdminSession::query()->where('user_id', $user->id)->delete();
    ...
    {
        $record = AdminSetting::query()->where('key', self::SETTINGS_KEY)->first();
        $settings = array_replace_recursive(self::DEFAULT_SETTINGS, $record?->value ?? []);
    ...
    public static function requireStrongPasswords(): bool
    {
        ...
        return (bool) $settings['security']['require_strong_passwords'];
    }
    ...
    private function settings(): array
    {
        ...
        return array_replace_recursive(self::DEFAULT_SETTINGS, $record?->value ?? []);
    }
